...
import birdpoint.funcionario.FuncionarioTableModelDigital;
...
public class CadastroDigital extends javax.swing.JDialog {
    ...
    private void capturarDigitalMaoDireita() {
        ...
        try {
            b = temp.serialize();
            funcionario.setDigitalDireita(b);
    ...
    private void btMaoDireitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btMaoDireitaActionPerformed
        JOptionPane.showMessageDialog(rootPane, "Peça que por gentileza o funcionario(a) " + tfNome.getText() + "\n\n Escolha um dedo da mão DIREITA que ele gostaria de cadastrar\n\n"
    ...
    private void btPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btPesquisarActionPerformed
        ...
        FuncionarioTableModelDigital itm = new FuncionarioTableModelDigital(lista);
        ...
        if (objetoRetorno != null) {
            ...
            if (funcionario.getDigitalDireita() != null) {
                jlMaoDireita.setText("Capturada!");
            }
            if (funcionario.getDigitalEsquerda() != null) {
                jlMaoEsquerda.setText("Capturada!");
            }
